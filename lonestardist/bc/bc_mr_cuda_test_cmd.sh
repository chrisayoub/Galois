...
# Tester bc_mr CPU
lonestardist/bc/bc_mr /net/ohm/export/iss/inputs/scalefree/rmat15.gr -graphTranspose=/net/ohm/export/iss/inputs/scalefree/transpose/rmat15.tgr -pset=c -numRoundSources=4096 -t=8 -runs=10 -statFile=cpu.txt
